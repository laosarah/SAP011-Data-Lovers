...
function mostraPoster(films) { 
  ...
  posterFilme.alt = "Ano:"+films.release_date; 
...
ordenacaoSelecionada.addEventListener("change", function () {  
  const ordenacaoAlterada = mostrarPosterOrdenado(ordenacaoSelecionada.value, ordemFiltro);  
...
filtroSelecionado.addEventListener("change", function () {  
  let filtroAlterado  = listaDeFilmes; 

  if (filtroSelecionado.value === "Filtro"){
    ordemFiltro = listaDeFilmes; 
